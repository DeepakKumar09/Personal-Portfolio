          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/DeepakYdv28/Project-Management-Tool" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/DeepakYdv28/mern-ecommerce" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://mern-store-gold.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
              Mern-Ecommerce is a comprehensive online shopping platform built using the MERN stack, which includes MongoDB, Express.js, React.js, and Node.js. This modern e-commerce application is designed to provide a seamless shopping experience for users while offering powerful tools for administrators to manage products, orders, and customers.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/DeepakYdv28/Placement-Cell" target="\_blank" rel="noreferrer">
